...
# gris_get_dependent_libraries(output_variable target [property_name value [...]])
  ...
  if(_argc_mod2 )
    ...
    arguments were: ${var_name} ${target} ${ARGN}
    ")
  endif()
  set(all_libraries )
    ...
    if(${ARGC} GREATER 2)
      foreach(_loop RANGE 3 ${ARGC} 2)
        ...
        if(${_var} MATCHES "-NOTFOUND$")
          ...
          continue()
          if(_debug)
            message("dropping ${_lib}, because no PROPERTY ${ARGV${_loop1}} was found")
          endif()
        else()
          if(${ARGV${_loop}} STREQUAL "BOOL:FALSE")
            if(_var)
              set(_keep OFF)
            endif()
          elseif(${ARGV${_loop}} STREQUAL "BOOL:TRUE")
            if(NOT _var)
              set(_keep OFF)
            endif()
          elseif(NOT ${_var} STREQUAL ${ARGV${_loop}})
            set(_keep OFF)
          endif()
          if(_debug AND NOT _keep)
            message("dropping ${_lib}, because ${ARGV${_loop1}} is not ${ARGV${_loop}}, but ${_var}.")
            break()
          endif()
        endif()
      endforeach()
